...
try {
    ...
    if (empty($data)) {
        ...
        echo json_encode(['success' => false, 'message' => 'Tidak ada data training untuk diekspor']);
        exit;
    }
    ...
    header('Content-Type: application/json');
    echo json_encode(['success' => false, 'message' => 'Error saat ekspor data training: ' . $e->getMessage()]);
    exit;
}
?> 